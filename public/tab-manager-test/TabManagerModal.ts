...
export class TabManagerModal {
        ...
        <div class="tab-manager-modal-body">
          ...
          <section class="tab-manager-section" id="display-settings-section">
            ...
            <div class="visible-tab-count-control">
              ...
              <span class="tab-count-preview"></span>
            </div>
          </section>
  ...
  private attachEventListeners(): void {
    ...
    countInput?.addEventListener('change', (e) => {
      ...
      if (this.onVisibleTabCountChange) {
   ...
   */
  private createTabListItem(tab: TabConfig): HTMLElement {
   ...
   */
  renderAppStore(apps: SDKApp[], filters?: AppStoreFilters): void {
