...
let updateReactionDisplayFn: ((messageId: string, reactions: any[], reactionBtn?: HTMLElement | null) => Promise<void>) | null = null;
let loadMessageReactionsFn: ((messageId: string, reactionBtn?: HTMLElement | null) => Promise<void>) | null = null;
...
(async () => {
  try {
    ...
    updateReactionDisplayFn = canopiModule.updateReactionDisplay || (canopiModule.default as any)?.updateReactionDisplay;
    loadMessageReactionsFn = canopiModule.loadMessageReactions || (canopiModule.default as any)?.loadMessageReactions;
...
if (typeof window !== 'undefined') {
  ...
  window.loadMessageReactions = async function(
    messageId: string, 
    reactionBtn: HTMLElement | null = null, 
    existingReactions: any[] | null = null
  ): Promise<void> {
