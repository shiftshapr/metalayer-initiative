...
class AvatarUtils {
   ...
   */
  static async getAvatarUrl(user: User, context: string = 'visibility'): Promise<AvatarData> {
    ...
    if (avatarUrl) {
      ...
      if (typeof window !== 'undefined' && window.currentUser) {
        const currentUser = window.currentUser as User;
   ...
   */
  static async createUnifiedAvatar(
    user: User,
    context: string = 'visibility',
