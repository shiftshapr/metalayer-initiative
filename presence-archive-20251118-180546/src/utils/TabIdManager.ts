...
declare const window: Window & {
  tabIdManager?: TabIdManager;
  TabIdManager?: typeof TabIdManager;
};

class TabIdManager {
  private currentTabId: number | null = null;
  private tabIdPromise: Promise<number | null> | null = null;
   ...
   * @private
   */
  private async _fetchTabId(): Promise<number | null> {
    try {
   ...
   */
  async refreshTabId(): Promise<number | null> {
    this.currentTabId = null;
    this.tabIdPromise = null;
