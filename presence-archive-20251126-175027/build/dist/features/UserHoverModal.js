...
class UserHoverModal {
    ...
    attachVisibilityAvatarHandlers() {
        ...
        document.addEventListener('mouseenter', (e) => {
            ...
            if (visibilityTab) {
                ...
                const avatarWrapper = target.closest('[data-user-id]');
    ...
    async getUserData(userId) {
            ...
            try {
                ...
                if (response) {
                    ...
                    userData = {
                        ...
                        communities: (Array.isArray(responseData.communities) ? responseData.communities : undefined) || (userData?.communities && Array.isArray(userData.communities) ? userData.communities : undefined)
                    };
                }
            }
            catch (error) {
        ...
        const communities = userData.communities && Array.isArray(userData.communities)
            ? userData.communities.filter((c) => typeof c === 'object' && c !== null && 'id' in c && 'name' in c)
            : undefined;
        return {
...
//# sourceMappingURL=UserHoverModal.js.map