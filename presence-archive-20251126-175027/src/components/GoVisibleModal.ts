  ...
  private createModal(): void {
    ...
    requestAnimationFrame(() => {
      if (this.modal) {
        ...
        const contentEl = this.modal.querySelector('.go-visible-modal-content') as HTMLElement;
        if (contentEl) {
...
if (typeof window !== 'undefined') {
  (window as Window & { 
    showGoVisibleModal?: () => void;
    openGoVisibleModal?: () => void;
    goVisibleModal?: GoVisibleModal;
  }).showGoVisibleModal = () => goVisibleModalInstance.show();
  
  (window as Window & { openGoVisibleModal?: () => void }).openGoVisibleModal = () => goVisibleModalInstance.show();
  
  (window as Window & { goVisibleModal?: GoVisibleModal }).goVisibleModal = goVisibleModalInstance;
