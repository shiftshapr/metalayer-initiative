...
declare const window: Window & {
  ...
  StatusDotHelper?: typeof StatusDotHelper;
};
...
export class StatusDotHelper {
  ...
  static getStatusDotColor(user: User | null): string | null {
    ...
    const availability = user.availability || user.status as Availability | undefined;
  ...
  static getStatusDotHTML(user: User | null, options: StatusDotOptions = {}): string {
    ...
    const availability = user.availability || user.status as Availability || (user.isActive ? 'AVAILABLE' : 'OFFLINE');
