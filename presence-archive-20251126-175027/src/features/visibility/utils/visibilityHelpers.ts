 ...
 */
export function normalizeVisibilityUsers(users: VisibilityUser[]): VisibilityUser[] {
 ...
 */
export function filterCurrentUser(
  users: VisibilityUser[],
  _currentUserEmail: string | null, // DEPRECATED: Kept for backward compatibility, not used
 ...
 */
export function formatLastSeenDisplay(lastSeen: string | null | undefined): string {
  if (!lastSeen) {
 ...
 */
export function formatTimeDisplay(enterTime: string | null | undefined): string {
  if (!enterTime) {
    return 'Unknown';
  }
 ...
 */
export function isUserActiveOnPage(
  user: VisibilityUser,
 ...
 */
export function getUserStatusText(
  user: VisibilityUser,
  currentPageId: string | null
): string {
  // Check if user is active on the same page
 ...
 */
export function createVisibilityUser(
  user: User,
  pageId?: string
): VisibilityUser {
  return {
