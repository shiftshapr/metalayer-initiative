...
/**
 * Window type extensions for page ID resolution
 */
interface WindowWithTabContext extends Window {
  tabContextManager?: {
 ...
 */
export function resolveCurrentPageId(tabId: string = 'visibility-tab'): PageIdResolution {
  const win = typeof window !== 'undefined' ? window as WindowWithTabContext : null;
 ...
 */
export function getCurrentPageId(tabId: string = 'visibility-tab'): string | null {
