...
class AvatarUtils {
    ...
    static async getAvatarUrl(user, context = 'visibility') {
        ...
        console.log(`Getting avatar for ${userIdentity} in context: ${context}`);
        let avatarUrl = null;
...
if (typeof window !== 'undefined') {
    ...
    // Also set on globalThis for module access
    ...
    console.log('✅ AvatarUtils exported to window and globalThis');
}
