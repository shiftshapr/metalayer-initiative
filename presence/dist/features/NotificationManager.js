...
export class NotificationManager {
     ...
     */
    buildNotificationData(type, data) {
        ...
        const notification = {
            ...
            anchor: (data.anchor && typeof data.anchor === 'object' && 'url' in data.anchor && 'selector' in data.anchor ? data.anchor.url : undefined),
     ...
     */
    getDefaultSettings() {
        const types = this.getAllNotificationTypes().reduce((acc, type) => {
            acc[type.id] = {
                id: type.id,
    ...
    async loadHistory() {
        try {
            ...
            this.history = result[this.historyKey] || [];
    ...
    async loadQueue() {
        try {
            ...
            this.queue = result[this.queueKey] || [];
