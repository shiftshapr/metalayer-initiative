 ...
 */
export async function updateVisibleTab(avatars, currentPageId, traceLimit) {
    ...
    const currentUser = win.currentUser ||
        win.stateManager?.getState('currentUser') ||
        null;
    ...
    const traceLimitConfig = { limit: resolvedTraceLimit };
