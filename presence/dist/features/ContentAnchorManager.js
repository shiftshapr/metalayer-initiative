...
export class ContentAnchorManager {
     ...
     */
    static validateTextSelection(selection) {
        ...
        const relevantSentences = sentences.filter(s => (s.start <= endOffset && s.end >= startOffset));
        ...
        const expandedText = fullText.substring(firstSentence.start, lastSentence.end).trim();
     ...
     */
    static createTextAnchor(selection, sourceUrl) {
     ...
     */
    static createImageAnchor(image, sourceUrl, coordinateRange) {
     ...
     *   - end (optional, but only valid if start is provided): bottom-right corner (creates rectangle)
     */
    static createVideoAnchor(video, sourceUrl, timestampRange, coordinateRange) {
     ...
     *   - end (optional, but only valid if start is provided): end timestamp (creates range)
     */
    static createAudioAnchor(audio, sourceUrl, timestampRange) {
     ...
     */
    static serializeAnchor(anchor) {
        return JSON.stringify(anchor);
    }
    /**
     * Deserializes a content anchor from a string
     */
    static deserializeAnchor(serialized) {
        try {
...
//# sourceMappingURL=ContentAnchorManager.js.map