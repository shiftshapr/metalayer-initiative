  ...
  async loadCurrentStatus() {
    try {
      ...
      if (currentUser.availability) {
        this.currentStatus = currentUser.availability;
  ...
  updateStatusUI(status) {
    ...
    statusOptions.forEach(option => {
      ...
      if (optionStatus === status) {
        option.style.background = 'var(--background-hover)';
        option.style.borderColor = 'var(--primary-accent)';
      } else {
...
window.StatusPickerModule = StatusPickerModule;

// Export for module use
if (typeof module !== 'undefined' && module.exports) {
  module.exports = StatusPickerModule;
}

console.log('✅ StatusPickerModule loaded');
