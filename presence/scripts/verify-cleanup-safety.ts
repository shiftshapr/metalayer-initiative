...
interface ReviewCandidate extends CleanupCandidate {
  references: string;
}
...
const candidates: CleanupCandidate[] = JSON.parse(fs.readFileSync(candidatesPath, 'utf-8'));
const safeToDelete: CleanupCandidate[] = [];
const needsReview: ReviewCandidate[] = [];
