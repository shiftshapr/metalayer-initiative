 ...
 */
export function getUserIdentity(source: User | null | undefined, fallback: string = 'unknown-user'): string {
 ...
 */
export function formatUserDisplayName(source: User | null | undefined, fallback: string = 'Unknown'): string {
 ...
 */
export function formatUserHandle(source: User | null | undefined, fallback: string = 'unknown'): string {
 ...
 */
export function ensureMessageContent(source: { content?: string } | null | undefined, fallback: string = ''): string {
 ...
 */
export function getAuraColorValue(source: User | null | undefined, fallback: string = '#aaaaaa'): string {
 ...
 */
export function getAvatarUrlWithFallback(source: User | null | undefined, fallback: string = '/icons/default-user.svg'): string {
 ...
 */
export function formatAuthorName(source: User | { name?: string; handle?: string; email?: string } | null | undefined, fallback: string = 'Unknown'): string {
