...
export class SubscriptionManager {
  ...
  async initialize(userId: string): Promise<void> {
    ...
    try {
      ...
      this.logger.error('Failed to initialize SubscriptionManager', error as unknown as LogData);
      throw error;
    }
  }
  ...
  async subscribe(options: CreateSubscriptionOptions): Promise<Subscription> {
    try {
      ...
      // Emit event
      this.emitEvent('created' as SubscriptionEvent, subscription);

      this.logger.info(`Subscription created: ${subscription.targetType}:${subscription.targetId}`);
      return subscription;
    } catch (error: unknown) {
      this.logger.error('Error creating subscription:', error as unknown as LogData);
      throw error;
    }
  }
  ...
  async updateSubscription(
    ...
    try {
      ...
      // Emit event
      this.emitEvent('updated' as SubscriptionEvent, subscription);

      this.logger.info(`Subscription updated: ${subscriptionId}`);
      return subscription;
    } catch (error: unknown) {
      this.logger.error('Error updating subscription', error as unknown as LogData);
      throw error;
    }
  }
  ...
  async unsubscribe(subscriptionId: string): Promise<void> {
    try {
      ...
      // Emit event
      this.emitEvent('deleted' as SubscriptionEvent, subscription);

      this.logger.info(`Subscription deleted: ${subscriptionId}`);
    } catch (error: unknown) {
      this.logger.error('Error deleting subscription:', error as unknown as LogData);
      throw error;
    }
  }
  ...
  async muteSubscription(subscriptionId: string, durationMs: number): Promise<void> {
    try {
      ...
      this.logger.error('Error muting subscription:', error as unknown as LogData);
      throw error;
    }
  }
  ...
  async unmuteSubscription(subscriptionId: string): Promise<void> {
    try {
      ...
      this.logger.error('Error unmuting subscription:', error as unknown as LogData);
      throw error;
    }
  }
  ...
  async enableSubscription(subscriptionId: string): Promise<void> {
    try {
      ...
      await this.saveSubscriptions();
      this.emitEvent('activated' as SubscriptionEvent, subscription);

      this.logger.info(`Subscription enabled: ${subscriptionId}`);
    } catch (error: unknown) {
      this.logger.error('Error enabling subscription:', error as unknown as LogData);
      throw error;
    }
  }
  ...
  async disableSubscription(subscriptionId: string): Promise<void> {
    try {
      ...
      await this.saveSubscriptions();
      this.emitEvent('deactivated' as SubscriptionEvent, subscription);

      this.logger.info(`Subscription disabled: ${subscriptionId}`);
    } catch (error: unknown) {
      this.logger.error('Error disabling subscription:', error as unknown as LogData);
      throw error;
    }
  }
  ...
  getStats(): SubscriptionStats {
    ...
    const stats: SubscriptionStats = {
      ...
      autoSubscribed: subscriptions.filter(sub => {
        const metadata = sub.metadata as { autoSubscribed?: boolean } | undefined;
  ...
  private async loadSubscriptions(): Promise<void> {
    try {
      ...
      this.logger.error('Error loading subscriptions', error as unknown as LogData);
      this.subscriptions.clear();
    }
  }
  ...
  private async saveSubscriptions(): Promise<void> {
    try {
      ...
      this.logger.error('Error saving subscriptions', error as unknown as LogData);
    }
  }
