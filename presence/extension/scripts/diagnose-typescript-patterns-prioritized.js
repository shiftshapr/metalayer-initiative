...
const patterns = Object.entries(patternMap).map(([pattern, patternIssues]) => {
...
writeFileSync(join(presenceDir, '../docs/TYPESCRIPT_PATTERNS_PRIORITIZED.json'), JSON.stringify(report, null, 2));
...
process.exit(0);
//# sourceMappingURL=diagnose-typescript-patterns-prioritized.js.map