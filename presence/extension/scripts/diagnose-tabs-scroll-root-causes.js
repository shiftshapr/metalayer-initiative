...
function diagnoseTabsHiddenIssue() {
    ...
    const win = window;
    const hasLoadChatHistory = win.loadChatHistory || win.MessagesModule?.loadChatHistory;
    ...
    stylesheets.forEach((sheet, sheetIndex) => {
        try {
            ...
            rules.forEach((rule) => {
                if (rule.selectorText && (rule.selectorText.includes('.sidebar-nav-main') ||
