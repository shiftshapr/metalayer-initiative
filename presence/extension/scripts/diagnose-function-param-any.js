...
function typeIncludesAny(node) {
    ...
    node.forEachChild(child => {
        if (!includesAny && typeIncludesAny(child)) {
            includesAny = true;
        }
    });
    return includesAny;
}
function getFunctionContext(parameter) {
...
//# sourceMappingURL=diagnose-function-param-any.js.map