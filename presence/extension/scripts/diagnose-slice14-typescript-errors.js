...
function main() {
    ...
    if (parsedArgs.options.help) {
        printHelp('diagnose-slice14-typescript-errors.ts', 'DIAGNOSTIC SCRIPT: Slice 14 TypeScript Errors. Identifies all TypeScript errors in Slice 14 files.', [
            'npx tsx presence/src/scripts/diagnose-slice14-typescript-errors.ts',
...
//# sourceMappingURL=diagnose-slice14-typescript-errors.js.map