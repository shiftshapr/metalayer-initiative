...
export class Web3AuthAdapter {
    ...
    async initialize() {
        ...
        try {
            ...
            if (typeof window === 'undefined' || !window.Web3AuthModal) {
            ...
            const Web3AuthModal = window.Web3AuthModal;
            ...
            // Initialize modal
            if (this.web3auth && typeof this.web3auth.initModal === 'function') {
    ...
    async isAuthenticated() {
        ...
        try {
            const connected = this.web3auth.connected || false;
            return connected;
        }
        catch (error) {
        ...
        try {
            ...
            const user = {
                ...
                metadata: {
                    ...
                    typeOfLogin: userInfo.metadata?.typeOfLogin,
