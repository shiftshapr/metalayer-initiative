...
class CursorVisibilityModule {
  ...
  private getCurrentPageId(): string {
    ...
    if (typeof window !== 'undefined' && (window as any).UIManager?.generatePageId) {
      return (window as any).UIManager.generatePageId(window.location.href);
    }
...
if (typeof window !== 'undefined') {
  (window as any).cursorVisibilityModule = cursorVisibilityModule;
}
