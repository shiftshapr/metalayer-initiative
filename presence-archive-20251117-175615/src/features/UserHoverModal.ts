...
declare const window: Window & typeof globalThis & {
  currentUser?: User;
  api?: {
    request(url: string, options?: { method?: string; body?: string; allow404?: boolean }): Promise<any>;
    getCommunities?(): Promise<Community[]>;
  };
  AvatarUtils?: {
    createUnifiedAvatar(userData: any, context: string, options?: any): Promise<string>;
  };
