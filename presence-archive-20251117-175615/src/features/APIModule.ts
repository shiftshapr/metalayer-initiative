...
interface APIRequestOptions {
  ...
  allow401?: boolean;
  allow500?: boolean;
  user?: any; // For passing user context
}
...
class MetaLayerAPI {
  ...
  async getChatHistory(communityId, threadId = null, uri = null) {
    ...
    const supabase = stateManagerInstance.getState('supabase') as any | undefined;
    ...
    try {
      ...
      if (uri) {
        ...
        pageId = typeof normalizedUrl === 'object' && normalizedUrl !== null ? (normalizedUrl as any).pageId : normalizedUrl;
      }
