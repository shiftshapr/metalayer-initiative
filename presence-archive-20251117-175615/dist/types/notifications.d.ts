 ...
 * Notification types
 */
export type NotificationType = 'MESSAGE_NEW' | 'MENTION' | 'REPLY' | 'FRIEND_AURA_CHANGE' | 'COMMUNITY_JOIN' | 'ROOM_INVITE' | 'SYSTEM_ALERT';
/**
 ...
 */
export type NotificationEvent = 'notification:created' | 'notification:shown' | 'notification:clicked' | 'notification:dismissed' | 'notification:read' | 'notification:queued' | 'notification:dequeued' | 'settings:changed' | 'permission:changed' | 'badge:updated' | 'anchor:navigated' | 'anchor:highlighted';
/**
